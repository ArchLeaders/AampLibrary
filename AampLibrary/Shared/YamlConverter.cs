    ...
    public class YamlConverter
    {
        ...
        private static string WriteParamData(ParamEntry entry)
        {
            ...
            switch (entry.ParamType)
            {
                ...
                case ParamType.String256: value = $"!str256 {((AampLibrary.StringEntry)entry.Value).ToString()}"; break;
                case ParamType.String32: value = $"!str32 {((AampLibrary.StringEntry)entry.Value).ToString()}"; break;
                case ParamType.String64: value = $"!str64 {((AampLibrary.StringEntry)entry.Value).ToString()}"; break;
                case ParamType.StringRef: value = $"!strRef {((AampLibrary.StringEntry)entry.Value).ToString()}"; break;
